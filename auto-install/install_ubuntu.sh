...
whiptail --msgbox --backtitle "Welcome" --title "PiFire DTFE - UBUNTU DEVEL EDITION - Automated Installer" "This installer will transform your Ubuntu Installation into a connected Smoker Controller development environment.  NOTE: This installer is intended to be run on a fresh install of Ubuntu Server OS." ${r} ${c}
...
echo "**                                                                     **"
echo "*************************************************************************"
$SUDO apt install python3-dev python3-pip python3-venv python3-scipy nginx git supervisor ttf-mscorefonts-installer redis-server libatlas-base-dev libopenjp2-7 -y
